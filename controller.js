...
const gerOptions = ["repeater_expect_clear", "40_expect_clear", "ks_clear", "ks_clear_restricted", "ks_expect_stop", "ks_stop", "clear", "clear_100", "clear_60", "clear_40", "stop", "expect_clear", "expect_100", "expect_40_or_60", "expect_stop", "main", "distant", "repeater"]
